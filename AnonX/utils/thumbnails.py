...
async def gen_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            image4.text((10, 10), "TOMXJERRY MUSIC", fill="white", font = font1, align ="left") 
            image4.text((670, 150), "TOM X MUSIC", fill="white", font = font2, stroke_width=2, stroke_fill="yellow", align ="left") 
